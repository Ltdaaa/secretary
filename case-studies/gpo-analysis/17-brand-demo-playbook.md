# 17 Brand Demo Playbook

Project: gpo-analysis

Goal: Analyze the local GPO computer vision project as an AI company delivery case.

Owner: Brand & Demo Agent

Purpose: Brand narrative, website copy, demo script, judge Q&A, and presentation arc.

## Executive Decision

| Decision | Conservative Starter Choice | Evidence Needed | Owner |
| --- | --- | --- | --- |
| Primary direction | Build a stable CPU-first demo and evidence package before heavy infrastructure | User goal, constraints, generated artifacts | Brand & Demo Agent |
