...
Owner: Evaluation & Test Agent

Purpose: Metrics, test sets, red-team cases, thresholds, regression checks.

## Executive Decision

| Decision | Conservative Starter Choice | Evidence Needed | Owner |
| --- | --- | --- | --- |
| Primary direction | Build a stable CPU-first demo and evidence package before heavy infrastructure | User goal, constraints, generated artifacts | Evaluation & Test Agent |
...
<!-- COMPANY_OS:Verification Evidence:START -->
## Company OS Findings: Verification Evidence
