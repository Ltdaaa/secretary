...
Purpose: Schema, cleaning rules, dedupe rules, splits, labels, and data risks.

## Executive Decision

| Decision | Conservative Starter Choice | Evidence Needed | Owner |
| --- | --- | --- | --- |
| Primary direction | Build a stable CPU-first demo and evidence package before heavy infrastructure | User goal, constraints, generated artifacts | Data Governance Agent |
...
<!-- COMPANY_OS:Data Quality:START -->
## Company OS Findings: Data Quality
