...
Register detected model artifacts and connect them to configs, metrics, and release status.

## Acceptance Criteria

Each model/checkpoint has owner, source, metric, version, and rollback notes.
